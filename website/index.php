...
<body>
    <div id="container1" class="centered">
        ...
        <a href="CHROMELINK" target="_blank" class="removeForOnboard" id="addOnLink-chrome">Get it for Chrome</a><br>
        <a href="#container2" id="more">More Info</a>
    </div>
    <div id="container2">
        <h3>How to use:</h3>
        <ol>
            <li class="removeForOnboard">Get it <!--<a href="FIREFOXLINK" target="_blank">for Firefox</a> or --><a href="CHROMELINK" target="_blank">for Chrome</a></li>
        ...
        <a href="CHROMELINK" target="_blank" class="addOnLink">Chrome</a><br>
